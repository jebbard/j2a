...
public class VariableReferenceParser extends AbstractTemplateSectionParser<VariableReference> {
	...
	/**
	 * @see de.je.utils.j2a.template.AbstractTemplateSectionParser#isIndicatingTemplateSection(de.je.utils.j2a.template.TemplateToken)
	 */
	@Override
	...
	/**
	 * @see de.je.utils.j2a.template.AbstractTemplateSectionParser#parseTemplateSection(de.je.utils.j2a.template.TemplateToken,
	 *      java.util.Iterator)
	 */
	@Override
